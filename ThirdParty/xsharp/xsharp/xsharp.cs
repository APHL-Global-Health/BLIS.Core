...
namespace XSharp
{
  ...
  public class XFont : XHandle
  {
    ...
    [DllImport("libX11.so")]
    public static extern int XFreeFont (IntPtr display, IntPtr font_struct);
    [DllImport("libX11.so")]
    public static extern int XTextExtents (ref XFontStruct font_struct, string _string, int nchars, out int direction_return, out int font_ascent_return, out int font_descent_return, IntPtr overall_return);
  }
  #endregion
  ...
  public class XGC : XHandle
  {
    ...
    [DllImport("libX11.so")]
    public static extern IntPtr XCreateGC (IntPtr display, IntPtr d, XGCValuesMask valuemask, ref XGCValues values);
    [DllImport("libX11.so")]
    public static extern int XFreeGC (IntPtr display, IntPtr gc);
    [DllImport("libX11.so")]
    public static extern int XSetForeground (IntPtr display, IntPtr gc, int foreground);
    [DllImport("libX11.so")]
    public static extern int XSetBackground (IntPtr display, IntPtr gc, int background);
    [DllImport("libX11.so")]
    ...
    [DllImport("libX11.so")]
    public static extern int XChangeGC (IntPtr display, IntPtr gc, int valuemask, ref XGCValues values);
  }
  #endregion
  ...
  public class XAtom
  {
    ...
    [DllImport("libX11.so")]
    public static extern string XGetAtomName (IntPtr display, int atom);
  }
  #endregion
  ...
  public class XColor : XHandle
  {
    ...
    [DllImport("libX11.so")]
    public static extern int XAllocNamedColor (IntPtr display, int colormap, string color_name, IntPtr screen_def_return, IntPtr exact_def_return);
    [DllImport("libX11.so")]
    public static extern int XAllocColor (IntPtr display, int colormap, IntPtr screen_int_out);
  }
  #endregion
  ...
  public class XDisplay : XHandle
  {
    ...
    public XDisplay (IntPtr display)
    {
      Screen = null;
      Handle = XOpenDisplay (display);
  ...
  public class XPixmap : XHandle
  {
    ...
    [DllImport("libXpm.so")]
    public static extern int XpmReadFileToPixmap (IntPtr display, IntPtr d, string filename, out IntPtr pixmap_return, out int shapemask_return, ref XpmAttributes attributes);
    [DllImport("libXpm.so")]
    public static extern int XpmCreatePixmapFromData (IntPtr display, IntPtr d, string[] data, out IntPtr pixmap_return, out int shapemask_return, ref XpmAttributes attributes);
  }
  #endregion
  ...
  public class XPointer : XHandle
  {
    ...
    [DllImport("libX11.so")]
    public static extern int XUngrabPointer (IntPtr display, int t);
    [DllImport("libX11.so")]
    public static extern int XGrabPointer (IntPtr display, IntPtr grab_window, bool owner_events, XEventMask event_mask, XGrabMode pointer_mode, XGrabMode keyboard_mode, int confine_to, IntPtr cursor, int time);
    [DllImport("libX11.so")]
    public static extern bool XQueryPointer (IntPtr display, IntPtr w, out IntPtr root_return, out IntPtr child_return, out int root_x_return, out int root_y_return, out int win_x_return, out int win_y_return, out int mask_return);
    [DllImport("libX11.so")]
    public static extern int XWarpPointer (IntPtr display, IntPtr src_w, IntPtr dest_w, int src_x, int src_y, int src_width, int src_height, int dest_x, int dest_y);
  }
  #endregion
  ...
  public class XScreen : XHandle
  {
    ...
    public static extern int XHeightOfScreen (IntPtr screen);
    [DllImport("libX11.so")]
    public static extern int XScreenNumberOfScreen (IntPtr screen);
    [DllImport("libX11.so")]
    public static extern IntPtr XDefaultScreenOfDisplay (IntPtr display);
    [DllImport("libX11.so")]
    public static extern int XBlackPixel (IntPtr display, int screen_number);
    [DllImport("libX11.so")]
    public static extern int XWhitePixel (IntPtr display, int screen_number);
    [DllImport("libX11.so")]
    public static extern int XDefaultColormapOfScreen (IntPtr screen);
  }
  #endregion
  ...
  public class XShape
  {
    ...
    public static extern bool XShapeQueryExtension (IntPtr display, out int event_base, out int error_base);
    [DllImport("libXext.so")]
    public static extern int XShapeQueryVersion (IntPtr display, out int major_version, out int minor_version);
    
  }
    /*[DllImport("libXext.so")]
    public static extern void XShapeCombineRegion(IntPtr display, int dest, int dest_kind, int x_off, int y_off, Region region, int op);
    [DllImport("libXext.so")]
    public static extern void XShapeCombineRectangles(IntPtr display, int dest, int dest_kind, int x_off, int y_off, IntPtr rectangles, int n_rects, int op, int ordering);
    [DllImport("libXext.so")]
    public static extern void XShapeCombineMask(IntPtr display, int dest, int dest_kind, int x_off, int y_off, int src, int op);
    [DllImport("libXext.so")]
    public static extern void XShapeCombineShape(IntPtr display, int dest, int dest_kind, int x_off, int y_off, int src, int src_kind, int op);
    [DllImport("libXext.so")]
    public static extern void XShapeOffsetShape(IntPtr display, int dest, int dest_kind, int x_off, int y_off);
    [DllImport("libXext.so")]
    public static extern int XShapeQueryExtents(IntPtr display, int w, bool bounding_shaped, out int x_bounding, out int y_bounding,
      out int w_bounding, out int h_bounding, out bool clip_shaped, out int x_clip, out int y_clip, out int w_clip, out int h_clip);
    [DllImport("libXext.so")]
    public static extern void XShapeSelectInput(IntPtr display, int w, int mask);
    [DllImport("libXext.so")]
    public static extern int XShapeInputSelected(IntPtr display, int w);
    [DllImport("libXext.so")]
    public static extern IntPtr XShapeGetRectangles(IntPtr display, int w, int kind, out int count, out int ordering);*/    
  #endregion
  ...
  public class XCursor : XHandle {
    ...
    [DllImport("libX11.so")]
    public static extern IntPtr XCreateFontCursor(IntPtr display, int shape);
    [DllImport("libX11.so")]
    public static extern int XDefineCursor(IntPtr display, IntPtr w, IntPtr cursor);
    [DllImport("libX11.so")]
...
//    [DllImport("libX11.so")]
//    public static extern int XGetWindowProperty(IntPtr display, IntPtr w, int property, 
...
//    [DllImport("libX11.so")]
//    public static extern int XChangeProperty(IntPtr display, IntPtr w, int property, int type, int format, PropMode mode, IntPtr data, int nelements);
//    
...
//    }  
    ...
    [DllImport("libX11.so")]
    public static extern int XMapSubwindows (IntPtr display, IntPtr window);
    [DllImport("libX11.so")]
    public static extern int XDestroyWindow (IntPtr display, IntPtr window);
    [DllImport("libX11.so")]
    public static extern IntPtr XCreateSimpleWindow (IntPtr display, IntPtr parent, int x, int y, int w, int h, int border_width, int border, int colour);
    [DllImport("libX11.so")]
    public static extern int XStoreName (IntPtr display, IntPtr w, string name);
    [DllImport("libX11.so")]
    public static extern int XFetchName (IntPtr display, IntPtr w, out string window_name_return);
    [DllImport("libX11.so")]
    public static extern int XSelectInput (IntPtr display, IntPtr w, XEventMask mask);
    [DllImport("libX11.so")]
    public static extern int XReparentWindow (IntPtr display, IntPtr w, IntPtr p, int x, int y);
    [DllImport("libX11.so")]
    public static extern int XClearWindow (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XDrawString (IntPtr display, IntPtr d, IntPtr gc, int x, int y, string _string, int length);
    [DllImport("libX11.so")]
    public static extern int XChangeWindowAttributes (IntPtr display, IntPtr w, XWindowAttributeFlags mask, IntPtr attributes);
    [DllImport("libX11.so")]
    public static extern int XGrabButton (IntPtr display, int button, XModMask modifiers, IntPtr grab_window, bool owner_events, XEventMask event_mask, XGrabMode pointer_mode, XGrabMode keyboard_mode, int confine_to, IntPtr cursor);
    [DllImport("libX11.so")]
    public static extern int XUngrabButton (IntPtr display, XMouseButton button, XModMask modifiers, IntPtr grab_window);
    [DllImport("libX11.so")]
    public static extern int XConfigureWindow (IntPtr display, IntPtr w, int value_mask, XWindowChanges changes);
    [DllImport("libX11.so")]
    public static extern int XGetWindowAttributes (IntPtr display, IntPtr w, out XWindowAttributes window_attributes_return);
    [DllImport("libX11.so")]
    public static extern int XUngrabPointer (IntPtr display, int t);
    [DllImport("libX11.so")]
    public static extern int XGrabPointer (IntPtr display, IntPtr grab_window, bool owner_events, XEventMask event_mask, XGrabMode pointer_mode, XGrabMode keyboard_mode, int confine_to, int cursor, int time);
    [DllImport("libX11.so")]
    public static extern int XSetInputFocus (IntPtr display, IntPtr focus, XInputFocus revert_to, int time);
    [DllImport("libX11.so")]
    ...
    [DllImport("libX11.so")]
    public static extern int XRaiseWindow (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XLowerWindow (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XSetWindowBackground (IntPtr display, IntPtr w, int background_pixel);
    [DllImport("libX11.so")]
    public static extern int XGrabKey (IntPtr display, int keycode, XModMask modifiers, IntPtr grab_window, bool owner_events, XGrabMode pointer_mode, XGrabMode keyboard_mode);
    [DllImport("libX11.so")]
    public static extern int XUngrabKey (IntPtr display, int keycode, XModMask modifiers, IntPtr grab_window);
    [DllImport("libX11.so")]
    public static extern int XKeysymToKeycode (IntPtr display, XKeySym keysym);
    [DllImport("libX11.so")]
    public static extern XKeySym XKeycodeToKeysym (IntPtr display, int keycode, int index);
    [DllImport("libX11.so")]
    public static extern XKeySym XLookupKeysym (ref XKeyEvent key_event, int index);
    [DllImport("libX11.so")]
    public static extern int XGetTransientForHint (IntPtr display, IntPtr w, out IntPtr window_return);
    [DllImport("libX11.so")]
    public static extern int XSetTransientForHint (IntPtr display, IntPtr w, IntPtr prop_window);
    [DllImport("libX11.so")]
    public static extern int XAddToSaveSet (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XRemoveFromSaveSet (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XKillClient (IntPtr display, IntPtr resource);
    [DllImport("libX11.so")]
    public static extern int XDeleteProperty (IntPtr display, IntPtr w, XAtom property);
    [DllImport("libX11.so")]
    public static extern IntPtr XGetWMHints (IntPtr display, IntPtr w);
    [DllImport("libX11.so")]
    public static extern int XGetNormalHints (IntPtr display, IntPtr w, IntPtr hints_return);
    [DllImport("libX11.so")]
    public static extern IntPtr XAllocSizeHints ();
    [DllImport("libX11.so")]
    public static extern int XFree (IntPtr data);
    [DllImport("libX11.so")]
    public static extern int XSetWMHints (IntPtr display, IntPtr w, XWMHints wmhints);
    [DllImport("libX11.so")]
    public static extern void XSetWMNormalHints (IntPtr display, IntPtr w, ref XSizeHints hints);
    [DllImport("libX11.so")]
    public static extern int XGetWMProtocols (IntPtr display, IntPtr w, IntPtr protocols_return, out int count_return);
    [DllImport("libX11.so")]
    public static extern int XDrawLine (IntPtr display, IntPtr d, IntPtr gc, int x1, int y1, int x2, int y2);
    [DllImport("libX11.so")]
    public static extern int XDrawRectangle (IntPtr display, IntPtr d, IntPtr gc, int x, int y, int width, int height);
    [DllImport("libX11.so")]
    public static extern int XGetGeometry (IntPtr display, IntPtr d, out IntPtr root_return, out int x_return, out int y_return, out int width_return, out int height_return, out int border_width_return, out int depth_return);
    [DllImport("libX11.so")]
    public static extern int XSetWindowBorder (IntPtr display, IntPtr w, int border_pixel);
    [DllImport("libX11.so")]
    public static extern int XGetClassHint (IntPtr display, IntPtr w, out XClassHint class_hint_return);
    [DllImport("libX11.so")]
    public static extern int XSetWindowBackgroundPixmap (IntPtr display, IntPtr w, IntPtr background_pixmap);
    [DllImport("libX11.so")]
    public static extern int XDefineCursor (IntPtr display, IntPtr w, IntPtr cursor);
    [DllImport("libX11.so")]
    public static extern int XRootWindow (IntPtr display, int screen);
    [DllImport("libX11.so")]
    public static extern bool XQueryPointer (IntPtr display, IntPtr w, out IntPtr root_return, out IntPtr child_return, out int root_x_return, out int root_y_return, out int win_x_return, out int win_y_return, out int mask_return);
    [DllImport("libX11.so")]
    public static extern int XSetWindowBorderWidth (IntPtr display, IntPtr w, int width);
  }
  #endregion
...
//    }
    ...
    [DllImport("libX11.so")]
    public static extern int XNextEvent (IntPtr display, IntPtr handle);
    [DllImport("libX11.so")]
    public static extern bool XCheckTypedEvent (IntPtr display, XEventType event_type, IntPtr event_return);
    [DllImport("libX11.so")]
    public static extern int XAllowEvents (IntPtr display, XEventMode event_mode, int time);
    [DllImport("libX11.so")]
    public static extern int XSendEvent (IntPtr display, IntPtr w, bool propagate, XEventMask event_mask, IntPtr event_send);
    [DllImport("libX11.so")]
